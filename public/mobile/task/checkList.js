let currentTaskId = null;
		...
		$(async function(){
			...
			$("#resetTooneSignature").click(function () {
			...
			$("#resetTloneSignature").click(function () {
			...
			$("#resetHoUnitSignature").click(function () {
			...
			$("#resetToTendererSignature").click(function () {
			...
			$("#resetHoTendererSignature").click(function () {
			...
			$("#resetToUnitSignature").click(function () {
